...
%         \hline
%         BPE Tokenizer 2 (no\_dup\_no\_punc) & TRUE & FALSE & FALSE & TRUE & FALSE & TRUE & TRUE \\
%         BPE Tokenizer 1 (simple dup) & TRUE & FALSE & FALSE & TRUE & FALSE & FALSE & TRUE \\
%         Word Tokenizer 4 (full) & TRUE & TRUE & TRUE & TRUE & TRUE & TRUE & TRUE \\
%         Word Tokenizer 3 (norm) & TRUE & TRUE & TRUE & TRUE & TRUE & FALSE & FALSE \\
%         Word Tokenizer 2 (simple) & TRUE & FALSE & FALSE & TRUE & FALSE & TRUE & FALSE \\
%         Word Tokenizer 1 (no) & FALSE & FALSE & FALSE & FALSE & FALSE & FALSE & FALSE \\
%         GPT Tokenizer 4 (full) & TRUE & TRUE & TRUE & TRUE & TRUE & TRUE & TRUE \\
%         GPT Tokenizer 3 (norm) & TRUE & TRUE & TRUE & TRUE & TRUE & FALSE & FALSE \\
%         GPT Tokenizer 2 (simpl) & TRUE & FALSE & FALSE & TRUE & FALSE & FALSE & FALSE \\
%         GPT Tokenizer 1 (no) & FALSE & FALSE & FALSE & FALSE & FALSE & FALSE & FALSE \\
%         Baseline (split espace) & FALSE & FALSE & FALSE & FALSE & FALSE & FALSE & FALSE \\
%         \hline
%     \end{tabular}
%     % \end{adjustbox}
